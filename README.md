...
* **LangSmith** integration for tracking all AI interactions.
...
3. Start chatting with the AI. Features include:

* Real-time token streaming
* Tool suggestions and execution
* Multi-thread conversation handling

4. **Add new tools** by creating functions and decorating them with `@tool` in your tools file.
